...
$(foreach build_type, user userdebug eng, \
    ...
    $(eval COMMON_LUNCH_CHOICES += aosp_virtio_arm64only_go-$(build_type)) \
    ...
    $(eval COMMON_LUNCH_CHOICES += lineage_virtio_arm64only_go-$(build_type)))
